...
namespace GymManager.Migrations
{
    ...
    [Migration("20250225182228_SeedTrainerAccounts")]
    partial class SeedTrainerAccounts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManager.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = 101,
                            Age = 30,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(992),
                            Email = "qsentrainer@gmail.com",
                            IsEmailConfirmed = false,
                            PasswordHash = "dummy",
                            PasswordSalt = "dummy",
                            RoleID = 2,
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(993),
                        ...
                        new
                        {
                            UserID = 102,
                            Age = 30,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(995),
                            Email = "kamentrainer@gmail.com",
                            IsEmailConfirmed = false,
                            PasswordHash = "dummy",
                            PasswordSalt = "dummy",
                            RoleID = 2,
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(995),
                        ...
                        new
                        {
                            UserID = 103,
                            Age = 30,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(997),
                            Email = "trainer3@gmail.com",
                            IsEmailConfirmed = false,
                            PasswordHash = "dummy",
                            PasswordSalt = "dummy",
                            RoleID = 2,
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(998),
                            UserName = "Trainer3"
                        },
                        new
                        {
                            UserID = 104,
                            Age = 30,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(999),
                            Email = "trainer4@gmail.com",
                            IsEmailConfirmed = false,
                            PasswordHash = "dummy",
                            PasswordSalt = "dummy",
                            RoleID = 2,
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1000),
                            UserName = "Trainer4"
                        },
                        new
                        {
                            UserID = 105,
                            Age = 30,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1001),
                            Email = "trainer5@gmail.com",
                            IsEmailConfirmed = false,
                            PasswordHash = "dummy",
                            PasswordSalt = "dummy",
                            RoleID = 2,
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1002),
                            UserName = "Trainer5"
                        },
                        new
                        {
                            UserID = 106,
                            Age = 30,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1003),
                            Email = "trainer6@gmail.com",
                            IsEmailConfirmed = false,
                            PasswordHash = "dummy",
                            PasswordSalt = "dummy",
                            RoleID = 2,
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1003),
                            UserName = "Trainer6"
                        },
                        new
                        {
                            UserID = 107,
                            Age = 30,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1005),
                            Email = "trainer7@gmail.com",
                            IsEmailConfirmed = false,
                            PasswordHash = "dummy",
                            PasswordSalt = "dummy",
                            RoleID = 2,
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1005),
                            UserName = "Trainer7"
                        },
                        new
                        {
                            UserID = 108,
                            Age = 30,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1007),
                            Email = "trainer8@gmail.com",
                            IsEmailConfirmed = false,
                            PasswordHash = "dummy",
                            PasswordSalt = "dummy",
                            RoleID = 2,
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 22, 28, 315, DateTimeKind.Utc).AddTicks(1007),
                            UserName = "Trainer8"
                        });
                });
